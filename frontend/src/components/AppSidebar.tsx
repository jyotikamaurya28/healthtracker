import { Home, Activity, BarChart3, Info, Heart } from "lucide-react";
...
const navItems = [
  ...
  { title: "Prediction", url: "/prediction", icon: Activity },
  { title: "Health Insights", url: "/insights", icon: BarChart3 },
      ...
      <SidebarFooter className="p-4">
        {!collapsed && (
          <div className="rounded-lg bg-sidebar-accent/50 p-3 text-xs text-sidebar-foreground/60">
            <p className="font-medium text-sidebar-foreground/80">AI Powered</p>
            <p className="mt-1">Disease risk analysis with ML</p>
          </div>
        )}
      </SidebarFooter>
    </Sidebar>
